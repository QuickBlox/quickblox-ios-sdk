...
@synthesize placeholderTextViewPasteDelegate;
...
- (BOOL)hasTextAttachment {
    BOOL __block hasTextAttachment = NO;
...
- (void)paste:(id)sender {
    if (!self.placeholderTextViewPasteDelegate ||
        [self.placeholderTextViewPasteDelegate placeHolderTextView:self

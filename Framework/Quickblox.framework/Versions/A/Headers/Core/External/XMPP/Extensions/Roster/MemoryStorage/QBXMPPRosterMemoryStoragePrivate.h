...
@interface QBXMPPUserMemoryStorage ()

- (id)initWithJID:(QBXMPPJID *)aJid;
- (id)initWithItem:(NSXMLElement *)item;

- (void)updateWithItem:(NSXMLElement *)item;

- (int)updateWithPresence:(QBXMPPPresence *)presence
            resourceClass:(Class)resourceClass
           andGetResource:(QBXMPPResourceMemoryStorage **)resourcePtr;
...
@interface QBXMPPResourceMemoryStorage ()

- (id)initWithPresence:(QBXMPPPresence *)aPresence;

- (void)updateWithPresence:(QBXMPPPresence *)presence;

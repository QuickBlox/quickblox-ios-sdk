...
/**
 ...
 @return An instance of QBRequest for cancel operation mainly.
 */
+ (QB_NONNULL QBRequest *)createPushToken:(QB_NONNULL QBMPushToken *)pushToken
                             successBlock:(QB_NULLABLE void (^)(QBResponse * QB_NONNULL_S response, QBMPushToken * QB_NONNULL_S token))successBlock
                               errorBlock:(QB_NULLABLE QBRequestErrorBlock)errorBlock __attribute__((deprecated("use '+[QBRequest createSubscription:successBlock:errorBlock:' instead.")));
...
/**
 ...
 @return An instance of QBRequest for cancel operation mainly.
 */
+ (QB_NONNULL QBRequest *)deletePushTokenWithID:(NSUInteger)ID
                                   successBlock:(QB_NULLABLE void (^)(QBResponse * QB_NONNULL_S response))successBlock
                                     errorBlock:(QB_NULLABLE QBRequestErrorBlock)errorBlock __attribute__((deprecated("use '+[QBRequest deleteSubscriptionWithID:successBlock:errorBlock:' instead.")));
...
+ (QB_NONNULL QBRequest *)registerSubscriptionForDeviceToken:(QB_NONNULL NSData *)deviceToken
                                                successBlock:(QB_NULLABLE void(^)(QBResponse * QB_NONNULL_S response, NSArray QB_GENERIC(QBMSubscription *) * QB_NULLABLE_S subscriptions))successBlock
                                                  errorBlock:(QB_NULLABLE void (^)(QBError * QB_NULLABLE_S error))errorBlock __attribute__((deprecated("use '+[QBRequest registerSubscriptionForDeviceToken:uniqueDeviceIdentifier:successBlock:errorBlock:' instead.")));
...
/** 
 ...
 @return An instance of QBRequest for cancel operation mainly.
 */
+ (QB_NONNULL QBRequest *)unregisterSubscriptionWithSuccessBlock:(QB_NULLABLE void (^)(QBResponse * QB_NONNULL_S response))successBlock
                                           errorBlock:(QB_NULLABLE void (^)(QBError * QB_NULLABLE_S error))errorBlock __attribute__((deprecated("use '+[QBRequest unregisterSubscriptionForUniqueDeviceIdentifier:successBlock:errorBlock:' instead.")));

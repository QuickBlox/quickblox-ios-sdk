...
/**
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)usersWithIDs:(NSString *)IDs successBlock:(void (^)(QBResponse *response, QBGeneralResponsePage *page, NSArray *users))successBlock
				 errorBlock:(void (^)(QBResponse *response))errorBlock;
/**
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)usersWithIDs:(NSString *)IDs page:(QBGeneralResponsePage *)page

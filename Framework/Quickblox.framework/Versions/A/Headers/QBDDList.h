...
@class QBDDListEnumerator;

struct QBDDListNode {
	void * element;
	struct QBDDListNode * prev;
	struct QBDDListNode * next;
};
typedef struct QBDDListNode DDListNode;
...
**/
- (QBDDListEnumerator *)listEnumerator;
- (QBDDListEnumerator *)reverseListEnumerator;

@end

@interface QBDDListEnumerator : NSObject
{

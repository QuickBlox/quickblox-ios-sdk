...
//  Quickblox
//
//  Created by Igor Khomenko on 9/3/14.
...
#define _QB_XMPP_RECONNECT_H

#define QB_DEFAULT_XMPP_RECONNECT_DELAY 2.0

#define QB_DEFAULT_XMPP_RECONNECT_TIMER_INTERVAL 20.0


@protocol QBXMPPReconnectDelegate;
...
@interface QBXMPPReconnect : QBXMPPModule
{
	Byte flags;
	Byte config;
...
- (void)xmppReconnect:(QBXMPPReconnect *)sender didDetectAccidentalDisconnect:(SCNetworkConnectionFlags)connectionFlags;
- (BOOL)xmppReconnect:(QBXMPPReconnect *)sender shouldAttemptAutoReconnect:(SCNetworkConnectionFlags)connectionFlags;

#else

- (void)xmppReconnect:(QBXMPPReconnect *)sender didDetectAccidentalDisconnect:(SCNetworkReachabilityFlags)connectionFlags;
- (BOOL)xmppReconnect:(QBXMPPReconnect *)sender shouldAttemptAutoReconnect:(SCNetworkReachabilityFlags)reachabilityFlags;

...
/** Create an event
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)createEvent:(QBMEvent *)event successBlock:(void (^)(QBResponse *response, QBMEvent *event))successBlock
				errorBlock:(QBRequestErrorBlock)errorBlock;
...
/** Create subscription for current device.
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)registerSubscriptionForDeviceToken:(NSData *)deviceToken successBlock:(void(^)(QBResponse *response, NSArray *subscriptions))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
...
/** Remove subscription for current device.
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)unregisterSubscriptionWithSuccessBlock:(void (^)(QBResponse *response))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
...
/** Send Apple based push notification to users
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)sendPush:(QBMPushMessage *)pushMessage toUsers:(NSString *)usersIDs successBlock:(void(^)(QBResponse *response, QBMEvent *event))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
...
/** Send simple push notification to users
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)sendPushWithText:(NSString *)text toUsers:(NSString *)usersIDs successBlock:(void(^)(QBResponse *response, QBMEvent *event))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
...
/** Send Apple based push notification to users with tags
 ...
 @return An instance of QBRequest. Use this instance to cancel the operation.
 */
+ (QBRequest *)sendPush:(QBMPushMessage *)pushMessage toUsersWithAnyOfTheseTags:(NSString *)usersTags successBlock:(void(^)(QBResponse *response, QBMEvent *event))successBlock errorBlock:(void (^)(NSError *error))errorBlock;

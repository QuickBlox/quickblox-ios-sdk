...
/**
 Determines whether local audio recording from mic is enabled or not.
 
 @discussion Use this property to stop and/or re-start local mic audio record. Use it, for example, if you need to turn off local audio record or restart audio unit.

 ...
 *
 *  @discussion 'sessionWillClose:' will be called when all connection are closed, '    :withTimeout:' will be called when session will be successfully closed by server.
 */
- (void)leave;

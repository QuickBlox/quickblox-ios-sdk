...
@class QBGCDAsyncSocketPreBuffer;
...
@interface QBGCDAsyncSocket : NSObject {
    ...
    NSMutableArray *writeVideoDataQueue;
    NSMutableArray *writeAudioDataQueue;
    QBGCDAsyncReadPacket *currentRead;
    QBGCDAsyncWritePacket *currentWrite;
    
    unsigned long socketFDBytesAvailable;
    
    QBGCDAsyncSocketPreBuffer *preBuffer;
    ...
    QBGCDAsyncSocketPreBuffer *sslPreBuffer;
 ...
 **/
- (void)socket:(QBGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust

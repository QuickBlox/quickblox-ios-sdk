...
- (void)request:(QBASIHTTPRequest *)request didReceiveBytes:(long long)bytes;
...
- (void)request:(QBASIHTTPRequest *)request didSendBytes:(long long)bytes;

// Called when a request needs to change the length of the content to download
- (void)request:(QBASIHTTPRequest *)request incrementDownloadSizeBy:(long long)newLength;

// Called when a request needs to change the length of the content to upload
// newLength may be less than zero when a request needs to remove the size of the internal buffer from progress tracking
- (void)request:(QBASIHTTPRequest *)request incrementUploadSizeBy:(long long)newLength;
@end

 ...
 * static const int qbxmppLogLevel = XMPP_LOG_LEVEL_VERBOSE;
 * 
 * If you wish to enable tracing, you could do something like this:
 * 
 * // Log levels: off, error, warn, info, verbose
 * static const int qbxmppLogLevel = XMPP_LOG_LEVEL_INFO | XMPP_LOG_FLAG_TRACE;
 * 
 * Step 3:
 ...
 *   static const int qbxmppLogLevel = XMPP_LOG_LEVEL_VERBOSE;
 * #else
 *   static const int qbxmppLogLevel = XMPP_LOG_LEVEL_WARN;
 * #endif
 * 
...
#define XMPP_LOG_ERROR   (qbxmppLogLevel & XMPP_LOG_FLAG_ERROR)
#define XMPP_LOG_WARN    (qbxmppLogLevel & XMPP_LOG_FLAG_WARN)
#define XMPP_LOG_INFO    (qbxmppLogLevel & XMPP_LOG_FLAG_INFO)
#define XMPP_LOG_VERBOSE (qbxmppLogLevel & XMPP_LOG_FLAG_VERBOSE)
#define XMPP_LOG_TRACE   (qbxmppLogLevel & XMPP_LOG_FLAG_TRACE)
...
#define XMPPLogError(frmt, ...)    LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_ERROR,   qbxmppLogLevel, XMPP_LOG_FLAG_ERROR,  \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogWarn(frmt, ...)     LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_WARN,    qbxmppLogLevel, XMPP_LOG_FLAG_WARN,   \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogInfo(frmt, ...)     LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_INFO,    qbxmppLogLevel, XMPP_LOG_FLAG_INFO,    \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogVerbose(frmt, ...)  LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_VERBOSE, qbxmppLogLevel, XMPP_LOG_FLAG_VERBOSE, \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogTrace()             LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_TRACE,   qbxmppLogLevel, XMPP_LOG_FLAG_TRACE, \
                                                  XMPP_LOG_CONTEXT, @"%@: %@", THIS_FILE, THIS_METHOD)

#define XMPPLogTrace2(frmt, ...)   LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_TRACE,   qbxmppLogLevel, XMPP_LOG_FLAG_TRACE, \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)


#define XMPPLogCError(frmt, ...)      LOG_C_MAYBE(XMPP_LOG_ASYNC_ERROR,   qbxmppLogLevel, XMPP_LOG_FLAG_ERROR,   \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogCWarn(frmt, ...)       LOG_C_MAYBE(XMPP_LOG_ASYNC_WARN,    qbxmppLogLevel, XMPP_LOG_FLAG_WARN,    \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogCInfo(frmt, ...)       LOG_C_MAYBE(XMPP_LOG_ASYNC_INFO,    qbxmppLogLevel, XMPP_LOG_FLAG_INFO,    \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogCVerbose(frmt, ...)    LOG_C_MAYBE(XMPP_LOG_ASYNC_VERBOSE, qbxmppLogLevel, XMPP_LOG_FLAG_VERBOSE, \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)

#define XMPPLogCTrace()               LOG_C_MAYBE(XMPP_LOG_ASYNC_TRACE,   qbxmppLogLevel, XMPP_LOG_FLAG_TRACE, \
                                                  XMPP_LOG_CONTEXT, @"%@: %s", THIS_FILE, __FUNCTION__)

#define XMPPLogCTrace2(frmt, ...)     LOG_C_MAYBE(XMPP_LOG_ASYNC_TRACE,   qbxmppLogLevel, XMPP_LOG_FLAG_TRACE, \
                                                  XMPP_LOG_CONTEXT, frmt, ##__VA_ARGS__)
...
#define XMPP_LOG_SEND      (qbxmppLogLevel & XMPP_LOG_FLAG_SEND)
#define XMPP_LOG_RECV_PRE  (qbxmppLogLevel & XMPP_LOG_FLAG_RECV_PRE)
#define XMPP_LOG_RECV_POST (qbxmppLogLevel & XMPP_LOG_FLAG_RECV_POST)
...
#define XMPPLogSend(format, ...)     LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_SEND, qbxmppLogLevel, XMPP_LOG_FLAG_SEND, \
                                                    XMPP_LOG_CONTEXT, format, ##__VA_ARGS__)

#define XMPPLogRecvPre(format, ...)  LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_RECV_PRE, qbxmppLogLevel, XMPP_LOG_FLAG_RECV_PRE, \
                                                    XMPP_LOG_CONTEXT, format, ##__VA_ARGS__)

#define XMPPLogRecvPost(format, ...) LOG_OBJC_MAYBE(XMPP_LOG_ASYNC_RECV_POST, qbxmppLogLevel, XMPP_LOG_FLAG_RECV_POST, \
                                                    XMPP_LOG_CONTEXT, format, ##__VA_ARGS__)

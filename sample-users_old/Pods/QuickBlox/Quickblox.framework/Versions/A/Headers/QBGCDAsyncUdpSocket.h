...
extern NSString *const QBGCDAsyncUdpSocketException;
extern NSString *const QBGCDAsyncUdpSocketErrorDomain;

extern NSString *const QBGCDAsyncUdpSocketQueueName;
extern NSString *const QBGCDAsyncUdpSocketThreadName;

enum QBGCDAsyncUdpSocketError
{
	QBGCDAsyncUdpSocketNoError = 0,          // Never used
	QBGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	QBGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	QBGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	QBGCDAsyncUdpSocketClosedError,          // The socket was closed
	QBGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
typedef enum QBGCDAsyncUdpSocketError QBGCDAsyncUdpSocketError;
 ...
 *
**/
typedef BOOL (^QBGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);
...
**/
- (void)setSendFilter:(QBGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(QBGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(QBGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(QBGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
...
@protocol QBGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(QBGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(QBGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(QBGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(QBGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(QBGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(QBGCDAsyncUdpSocket *)sock withError:(NSError *)error;

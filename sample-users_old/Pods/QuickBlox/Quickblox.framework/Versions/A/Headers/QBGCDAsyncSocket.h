 ...
 * but our socket would still be writeable and the remote apiDomain could continue to receive our data.
 * 
 ...
 * 
 * The vast majority of the time if the read stream is closed it's because the remote apiDomain closed its socket.

//
// XMPPivacy
// A chat room. XEP-0016 Implementation.
//
...
extern NSString *const QBXMPPPrivacyErrorDomain;

typedef enum QBXMPPPrivacyErrorCode
{
	QBXMPPPrivacyQueryTimeout,  // No response from server
	QBXMPPPrivacyDisconnect,    // XMPP disconnection
	
} QBXMPPPrivacyErrorCode;



@interface QBXMPPPrivacy : QBXMPPModule
{
...
@protocol QBXMPPPrivacyDelegate
@optional
...
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didReceiveListNames:(NSArray *)listNames;
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didNotReceiveListNamesDueToError:(id)error;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didReceiveListWithName:(NSString *)name items:(NSArray *)items;
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didNotReceiveListWithName:(NSString *)name error:(id)error;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didReceivePushWithListName:(NSString *)name;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didSetActiveListName:(NSString *)name;
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didNotSetActiveListName:(NSString *)name error:(id)error;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didSetDefaultListName:(NSString *)name;
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didNotSetDefaultListName:(NSString *)name error:(id)error;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didSetListWithName:(NSString *)name;
- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didNotSetListWithName:(NSString *)name error:(id)error;

- (void)xmppPrivacy:(QBXMPPPrivacy *)sender didRemovedListWithName:(NSString *)name;
